...
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
	...
	//保存过滤规则要排除的注解,即spring默认的@Component,@Repository,@Service,@Controller注解的bean
	//以及JAVA EE 6的@ManagedBean和JSR-330的@Named注解
	...
	protected void registerDefaultFilters() {
		//向要包含的过滤规则中添加@Component注解类,注意spring中@Repository,@Service,@Controller都是Component
